...
export default class Roth extends React.Component {
  render() {
    return (
      <div>
        <div id="blogHeader">
          <h1 id="blogTitle"> To Roth or Not to Roth? </h1>
          <h3 id="blogDate">June 19, 2018</h3>
        </div>
        <div id="blogContent">
          <img id="blogSingleImage" src={RothPic} alt="Roth or no?" />
          <div id="blogSection">
            <h4 id="sectionTitle">OKAY....</h4>
            <p id="blogPara">
          ...
          <div id="blogSection">
            <h4 id="sectionTitle">TRADITIONAL 401K:</h4>
            <p id="blogPara">
          ...
          <div id="blogSection">
            <h4 id="sectionTitle"> ROTH 401K:</h4>
            <p id="blogPara">
          ...
          <div id="blogSection">
            ...
            <div id="imagePara">
              ...
              <div id="imageBox">
                <img id="blogImage" src={crystalBall} alt="crystalBall" />
              </div>
            </div>
            <p id="blogPara">
            ...
            <div id="imagePara">
              ...
              <div id="imageBox">
                <img id="blogImage" src={GDP} alt="GDP" />
                <p id="imageDescription">
